...
```
![logo](https://raw.githubusercontent.com/yourvpsmaster2/DNS-AGN/main/AGN-DNS.png)
...
# Installation
```
rm -rf install; apt update; wget https://github.com/yourvpsmaster2/SlowDNS/raw/main/install; chmod 777 install; ./install --start
